    ...
    <div className="hero-section-wrapper" id="home">
      ...
      <div class="hero-section-container">
        <div className="hero-text">
          <span className="hero-text-up">we provide formalin free</span> <br />{" "}
          <span className="hero-text-down-1">fresh</span>{" "}
          <span className="hero-text-down-2">mangoes.</span>
        </div>
